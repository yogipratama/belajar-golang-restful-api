...
func TestCreateCategorySuccess(t *testing.T) {
	...
	requestBody := strings.NewReader(`{"name": "Elektronik"}`)
	...
	assert.Equal(t, "Elektronik", responseBody["data"].(map[string]any)["name"])
}
...
func TestUpdateCategorySuccess(t *testing.T) {
	...
	assert.Equal(t, "Smartphone", responseBody["data"].(map[string]any)["name"])
}
